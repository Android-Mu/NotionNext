...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '生加', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个草根互联网打工人', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://shengplus.com', // 网站地址
